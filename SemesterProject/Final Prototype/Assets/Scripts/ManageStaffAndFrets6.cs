...
public class ManageStaffAndFrets6 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Resources.Load<Sprite>("E_6_Staff"),//28
        Resources.Load<Sprite>("F_6_Staff"),//29
        Resources.Load<Sprite>("G_6_Staff"),//30
        Resources.Load<Sprite>("E_6_Fret"),//31
        Resources.Load<Sprite>("F_6_Fret"),//32
        Resources.Load<Sprite>("G_6_Fret")//33
    };
        displayStaff();
        displayFrets();
    }
    ...
    public void addFrets(int rank)
    {
        ...
        else if (question == "E_6_Staff" || question == "F_6_Staff" || question == "G_6_Staff")
        {
            switch (rank)
            {
                case 1:
    ...
    public void checkAnswer(string answer, GameObject selectedNote)
    {
       string nameOfSelectedNote = "";
        ...
        else if (answer == "E_6_Staff" || answer == "F_6_Staff" || answer == "G_6_Staff")
        {
            switch (tagValue)
            {
                case 1:
                    nameOfSelectedNote = "E_6_Staff";
                    break;
                case 2:
                    nameOfSelectedNote = "F_6_Staff";
                    break;
                case 3:
                    nameOfSelectedNote = "G_6_Staff";
                    break;
            }
        }
