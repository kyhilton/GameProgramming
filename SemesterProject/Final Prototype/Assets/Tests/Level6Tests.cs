...
public class Level6Tests: InputTestFixture
{
    ...
    {
        SceneManager.LoadScene("playLevel6");
        base.Setup();
    ...
    {
        base.TearDown();
        SceneManager.LoadScene("playLevel6"); // Unloading the last loaded scene Assets/Resources/test_scene.unity(build index: 0), is not supported. Please use SceneManager.LoadScene()/EditorSceneManager.OpenScene() to switch to another scene.
    }
    ...
    public IEnumerator AnswerSelected()
    {
        ...
        GameObject AnswerSelected = GameObject.Find("gameManager").GetComponent<ManageStaffAndFrets6>().retrieveSelectedAnswer();
    ...
    public IEnumerator ScoreIncreases()
    {
        ...
        int score = GameObject.Find("gameManager").GetComponent<ManageStaffAndFrets6>().retrieveScore();
