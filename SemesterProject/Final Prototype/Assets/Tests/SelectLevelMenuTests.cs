...
public class SelectLevelMenuTests : InputTestFixture
{
    Mouse mouse;
    Keyboard keyboard;
        ...
        {
            base.TearDown();
            SceneManager.LoadScene("levelSelect"); // Unloading the last loaded scene Assets/Resources/test_scene.unity(build index: 0), is not supported. Please use SceneManager.LoadScene()/EditorSceneManager.OpenScene() to switch to another scene.
        }
    ...
    [UnityTest]
    public IEnumerator LevelOneButtonWorks()
    {
        ...
        Assert.AreEqual("playLevel1", SceneManager.GetActiveScene().name, "Game scene not loaded after clicking LevelOneButton");
    }
    [UnityTest]
    public IEnumerator LevelTwoButtonWorks()
    {
        ...
        // Assert that the current scene is now the Game scene
        Assert.AreEqual("playLevel2", SceneManager.GetActiveScene().name, "Game scene not loaded after clicking LevelTwoButton");
    }
    [UnityTest]
    public IEnumerator LevelThreeButtonWorks()
    {
        ...
        // Assert that the current scene is now the Game scene
        Assert.AreEqual("playLevel3", SceneManager.GetActiveScene().name, "Game scene not loaded after clicking LevelThreeButton");
    }
    [UnityTest]
    public IEnumerator LevelFourButtonWorks()
    {
        ...
        // Assert that the current scene is now the Game scene
        Assert.AreEqual("playLevel4", SceneManager.GetActiveScene().name, "Game scene not loaded after clicking LevelFourButton");
    }
    [UnityTest]
    public IEnumerator LevelFiveButtonWorks()
    {
        ...
        // Assert that the current scene is now the Game scene
        Assert.AreEqual("playLevel5", SceneManager.GetActiveScene().name, "Game scene not loaded after clicking LevelFiveButton");
    }
    [UnityTest]
    public IEnumerator LevelSixButtonWorks()
    {
        ...
        // Assert that the current scene is now the Game scene
        Assert.AreEqual("playLevel6", SceneManager.GetActiveScene().name, "Game scene not loaded after clicking LevelSixButton");
    }
