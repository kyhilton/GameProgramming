...
public class Level1Tests: InputTestFixture
{
    ...
    public IEnumerator AnswerSelected()
    {
        ...
        GameObject AnswerSelected = GameObject.Find("gameManager").GetComponent<ManageStaffAndFrets>().retrieveSelectedAnswer();
    ...
    public IEnumerator ScoreIncreases()
    {
        ...
        int score = GameObject.Find("gameManager").GetComponent<ManageStaffAndFrets>().retrieveScore();
