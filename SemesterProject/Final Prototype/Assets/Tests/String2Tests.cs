...
public class String2Tests: InputTestFixture
{
    ...
    {
        base.TearDown();
        SceneManager.LoadScene("viewNotes2"); // Unloading the last loaded scene Assets/Resources/test_scene.unity(build index: 0), is not supported. Please use SceneManager.LoadScene()/EditorSceneManager.OpenScene() to switch to another scene.
    }
